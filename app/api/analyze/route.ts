...
- story_intent_tags / modern_aesthetic_tags: several list entries are explicitly feminine-coded (e.g. "she'll regret losing you", "clean girl morning", "Slavic sad girl", "hot girl summer", "dark feminine", "cool girl car selfie", "coquette", "clean girl", "mob wife", "pinterest girl", "alt girl"). Only pick one of these when the photo's subject genuinely reads as feminine. For a masculine-presenting or gender-neutral subject (or no person at all), pick from the neutral tags, or the masculine/edge-coded entries ('gym flex', 'night drive alone', 'hustle grind', 'rap swagger', 'rock grit', 'stoic heartbreak', 'streetwear energy', 'game day'), or the cultural-aesthetic entries ('French chic', 'Scandi minimal', 'Latin heat', 'Japanese minimalist', 'K-pop glossy') where the photo warrants it — do not force a feminine-coded tag just because it's the closest thematic fit.`;
