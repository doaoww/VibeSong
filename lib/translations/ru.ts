...
export const ru: Translation = {
  ...
  landing: {
    ...
    heroMicrocopy: "3 бесплатных мэтча · Любое фото подойдёт",
    ...
    finalCtaBody: "Загрузи первое фото бесплатно.",
  ...
  home: {
    ...
    freeMatches: (credits: number) => `${credits} мэтчей · Любое фото подойдёт`,
  ...
  playlistImport: {
    heading: "Импорт плейлиста",
    subtitle: "Вставь публичную ссылку на плейлист Apple Music, и мы добавим эти песни во вкус.",
    urlLabel: "Ссылка на плейлист Apple Music",
    placeholder: "https://music.apple.com/us/playlist/...",
    importLabel: "Импортировать плейлист",
    reading: "Читаем плейлист...",
    emptyUrl: "Сначала вставь ссылку на плейлист Apple Music.",
    genericError: "Не удалось прочитать плейлист - можно вставить песни вручную.",
    manualFallback: "Вставить песни вручную",
    addedCount: (added: number, total: number) => `Добавлено ${added} из ${total} песен`,
    skipped: (count: number) => `${count} песен не удалось добавить.`,
    truncated: "Импортировали первые 30 треков.",
    noSongsAdded: "Песни не добавлены.",
  },
  explore: {
    heading: "Обзор",
    realMatches: "Реальные мэтчи",
  ...
  onboarding: {
    ...
    storySongs: {
      heading: "Импорт плейлиста",
      subtitle: "Вставь ссылку на плейлист Apple Music, чтобы добавить эти песни во вкус.",
