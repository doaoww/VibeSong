export const en = {
  ...
  landing: {
    ...
    heroMicrocopy: "3 free matches · Any photo works",
    ...
    finalCtaBody: "Upload your first photo free.",
  ...
  playlistImport: {
    ...
    subtitle: "Paste a public Apple Music playlist link and we'll add those songs to your taste.",
    urlLabel: "Apple Music playlist link",
    placeholder: "https://music.apple.com/us/playlist/...",
    importLabel: "Import playlist",
    reading: "Reading your playlist...",
    emptyUrl: "Paste an Apple Music playlist link first.",
    genericError: "Couldn't read that playlist - paste songs instead.",
    manualFallback: "Paste songs instead",
    addedCount: (added: number, total: number) => `Added ${added} of ${total} songs`,
    skipped: (count: number) => `${count} song${count === 1 ? "" : "s"} couldn't be added.`,
    truncated: "Imported the first 30 tracks.",
    noSongsAdded: "No songs were added.",
  },
  explore: {
    heading: "Explore",
    realMatches: "Real matches",
  ...
  onboarding: {
    ...
    storySongs: {
      heading: "Import a playlist",
      subtitle: "Paste an Apple Music playlist link to add those songs to your taste.",
